...
//                 </div>
//                 {data.lastOrder.isForeign && data.lastOrder.origTotal != null && (
//                   <div style={{ fontSize: 10.5, color: '#6A675F', marginTop: 1, fontFamily: 'monospace' }}>
//                     {data.lastOrder.currency} {data.lastOrder.origTotal.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
//                     {data.lastOrder.conversionRate ? ` @ ${data.lastOrder.conversionRate}` : ''}
//                   </div>
//                 )}
//               </div>
//             </div>
