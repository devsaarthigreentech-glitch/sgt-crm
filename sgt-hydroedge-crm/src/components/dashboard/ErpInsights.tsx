...
function readyFor(p: Product, target: number) {
  ...
  export default function ErpInsights() {
    ...
    // Collapsible Final Assembly / capacity calculator (collapsed by default so
    // the financials and other dashboard sections below stay reachable).
    ...
    return (
      <div style={{ background: C.off, padding: 20, borderRadius: 14, fontFamily: 'system-ui, sans-serif' }}>
        ...
        {/* Collapsible production-capacity calculator */}
        <div style={{ borderTop: '1px solid #ece9df', marginTop: 6, paddingTop: 14 }}>
          <button
